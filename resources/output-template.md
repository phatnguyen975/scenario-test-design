# Scenario Test Design — Output Template
...
```markdown
# Scenario Test Design — [Feature Name]
...
| ----- | ------------------------------------- | ----------------- | -------- | --------------- | ------------ |
| SC-01 | [Full name: Actor + Action + Context] | Happy Path        | P1       | [Actor]         | BR-01, FR-02 |
| SC-02 | [Full name]                           | Negative          | P2       | [Actor]         | BR-01        |
| SC-03 | [Full name]                           | Error Recovery    | P2       | [Actor]         | FR-03        |
| SC-04 | [Full name]                           | Concurrent        | P3       | [Actor]         | BR-02        |
| SC-05 | [Full name]                           | Security & Misuse | P1       | Disfavored User | CON-01       |

**Summary:** [N] total scenarios — [x] Happy Path, [y] Negative, [z] Error Recovery, [w] Concurrent, [v] Security & Misuse
...
| 4   | Scenarios tagged with coverage labels where useful (Happy Path, Negative, Error Recovery, etc.) | ✅ / ❌ |
...
| 🚩 One or more BRs/FRs with no covering scenario — regardless of total scenario count, any uncovered requirement is a gap | ✅ Clear / ❌ Found |
